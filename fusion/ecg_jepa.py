...
class MaskTransformer(nn.Module):
    def __init__(
        ...
        self.encoder_blocks = Encoder_Block(embed_dim=embed_dim, depth=depth, num_heads=num_heads, mlp_ratio=mlp_ratio,
                                            qkv_bias=qkv_bias, qk_scale=qk_scale, drop_rate=drop_rate,
                                            attn_drop_rate=attn_drop_rate, drop_path_rate=dpr, norm_layer=norm_layer)
...
class ecg_jepa(nn.Module):
    def __init__(
        ...
        self.predictor = MaskTransformerPredictor(embed_dim=encoder_embed_dim, predictor_embed_dim=predictor_embed_dim,
                                                  ...
                                                  init_std=init_std, c=self.c, p=self.p, t=self.t, pos_type=pos_type)
